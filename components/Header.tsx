    ...
    >
      <div className="container-x flex items-center justify-between h-16 md:h-18">
        ...
        <div className="hidden md:flex items-center gap-3">
          {/* WhatsApp directo al fundador — menos fricción que el form */}
          <a
            href="https://wa.me/5493571549321?text=Hola!%20Vi%20Dentidad%20y%20quer%C3%ADa%20saber%20m%C3%A1s%20sobre%20la%20prueba%20de%2014%20d%C3%ADas."
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Contactar por WhatsApp"
            className="inline-flex items-center justify-center h-10 w-10 rounded-full bg-[#25D366] hover:bg-[#1ebe5d] active:scale-95 transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-[#25D366]/40"
          >
            <svg
              width="20"
              height="20"
          ...
          <div className="container-x py-4 flex flex-col gap-1">
            ...
            <div className="pt-3 mt-2 border-t border-border space-y-2">
              ...
              <a
                ...
                rel="noopener noreferrer"
                onClick={() => setMobileOpen(false)}
                className="w-full inline-flex items-center justify-center gap-2 bg-[#25D366] hover:bg-[#1ebe5d] text-white font-bold py-3 px-5 rounded-lg transition-all"
              >
