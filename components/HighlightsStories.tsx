 ...
 *
 * - Se deslizan para los costados, de a una (scroll-snap nativo: el gesto lo
 *   maneja el navegador, sin librerías).
  ...
  return (
    <div role="region" aria-roledescription="carrusel" aria-label="Funciones destacadas">
      ...
      <p className="mt-1 text-center text-xs text-ink-3">
        Deslizá o tocá la tarjeta para pasar · {active + 1} de {slides.length}
      </p>
    </div>
  );
}
